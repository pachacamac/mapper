**Mapper [![Gem Version](https://badge.fury.io/rb/mapper.svg)](http://badge.fury.io/rb/mapper) - A tiny geo coordinate converter - basically for plotting latitude/longitude pairs to an image**
